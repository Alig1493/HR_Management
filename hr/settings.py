...
REST_AUTH_SERIALIZERS = {
    'LOGIN_SERIALIZER': 'hr.users.serializers.LoginSerializer',
    'USER_DETAILS_SERIALIZER': 'hr.users.serializers.UserDetailsSerializer',
}

REST_AUTH_REGISTER_SERIALIZERS = {'REGISTER_SERIALIZER': 'hr.users.serializers.RegisterSerializer',}
